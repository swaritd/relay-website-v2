...
function RelayLogo({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg border p-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-4">Monthly Appointments</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-4">Average Appointment Value</label>
            <div className="relative">
              <input
                type="range"
                min="50"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-4">Missed Calls Percentage</label>
            <div className="relative">
              <input
                type="range"
                min="0"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-2">
              <RelayLogo />
              <span className="text-xl font-semibold" style={{ color: "#11475b" }}>
                Relay
              </span>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-semibold" style={{ color: "#11475b" }}>
                Relay
              </span>
            </div>
